...
BASE_DIR = 'paper_percentage/p-0.30000000000000004/'
DATA_DIR = '../data/'
...
for m in mon:
    ...
    for fold in range(len(FOLDS)):
        ...
        print(latest_file)
        shutil.copy(latest_file, f"../all models/{str(m)}/{model_name}")
        ...
        # plt.show()
        plt.savefig(f"../all models/{str(m)}/results/month_{str(m)}_fold_{str(best_combo[1])}.png")
